        ...
        public bool TryDoSpawn()
        {
            ...
            if (fishTrapUsesInternal < 1)
            {
                ...
                if (rebuild)
                {
                        ...
                        GenConstruct.PlaceBlueprintForBuild(this.parent.def, this.parent.Position, this.parent.Map,this.parent.Rotation, Faction.OfPlayer, this.parent.Stuff, null, null);
