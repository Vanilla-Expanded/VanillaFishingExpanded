...
{
  /*  public class ItemCraftTrackerWithIngredientsFishing : Tracker<Thing>
    {

        public override string Key => "ItemCraftTrackerWithIngredientsFishing";

        public override MethodInfo MethodHook => AccessTools.Method(typeof(QuestManager), nameof(QuestManager.Notify_ThingsProduced));
        public override MethodInfo PatchMethod => AccessTools.Method(typeof(VanillaFishing_QuestManager_Notify_ThingsProduced_Patch), nameof(VanillaFishing_QuestManager_Notify_ThingsProduced_Patch.CheckItemCraftedIngredients));
        ...
        public ItemCraftTrackerWithIngredientsFishing()
        {
        }
        ...
        public ItemCraftTrackerWithIngredientsFishing(ItemCraftTrackerWithIngredientsFishing reference) : base(reference)
        {
            def = reference.def;
