...
namespace VCE_Fishing.Options
{
...

    {
        ...
        public static void DoWindowContents(Rect inRect)
        {
            ...
            ls.Begin(inRect);
            ls.Gap(12f);
            ls.Label(new TaggedString("VCEF_minimumZoneSize".Translate()+": "+ VCEF_minimumZoneSize), -1, "VCEF_minimumZoneSizeTooltip".Translate());
            VCEF_minimumZoneSize = (int)ls.Slider(VCEF_minimumZoneSize, 1,100);
            ls.Gap(12f);

            ls.Label(new TaggedString("VCEF_smallFishDurationFactor".Translate() + ": " + VCEF_smallFishDurationFactor), -1, "VCEF_smallFishDurationFactorTooltip".Translate());
            VCEF_smallFishDurationFactor = (int)ls.Slider(VCEF_smallFishDurationFactor, 1000, 10000);
            ls.Gap(12f);

            ls.Label(new TaggedString("VCEF_chanceForSpecials".Translate() + ": " + VCEF_chanceForSpecials+"%"), -1, "VCEF_chanceForSpecialsTooltip".Translate());
            VCEF_chanceForSpecials = (int)ls.Slider(VCEF_chanceForSpecials, 0, 100);
            ls.Gap(12f);

            ls.Label(new TaggedString("VCEF_minMapTempForLowFish".Translate() + ": " + (int)VCEF_minMapTempForLowFish + "ºC"), -1, "VCEF_minMapTempForLowFishTooltip".Translate());
            VCEF_minMapTempForLowFish = ls.Slider(VCEF_minMapTempForLowFish, -50, 50);
            ls.Gap(12f);

            ls.Label(new TaggedString("VCEF_maxMapTempForLowFish".Translate() + ": " + (int)VCEF_maxMapTempForLowFish + "ºC"), -1, "VCEF_maxMapTempForLowFishTooltip".Translate());
